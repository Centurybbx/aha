...
def load_config(path: Path | None = None, overrides: dict[str, Any] | None = None) -> AhaConfig:
    config_path = path or (Path.home() / ".aha" / "config.json")
    data: dict[str, Any] = {}
